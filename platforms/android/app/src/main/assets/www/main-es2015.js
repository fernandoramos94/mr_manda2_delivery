...
const routes = [
    {
        path: '',
        loadChildren: () => Promise.all(/*! import() | pages-tabs-tabs-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-tabs-tabs-module")]).then(__webpack_require__.bind(null, /*! ./pages/tabs/tabs.module */ "./src/app/pages/tabs/tabs.module.ts")).then(m => m.TabsPageModule),
    ...
    {
        path: 'orders',
        loadChildren: () => Promise.all(/*! import() | pages-orders-orders-module */[__webpack_require__.e("default~orders-orders-module~pages-orders-orders-module"), __webpack_require__.e("common")]).then(__webpack_require__.bind(null, /*! ./pages/orders/orders.module */ "./src/app/pages/orders/orders.module.ts")).then(m => m.OrdersPageModule)
    },
    {
        path: 'order-detail',
    ...
    {
        path: 'profile',
        loadChildren: () => Promise.all(/*! import() | pages-profile-profile-module */[__webpack_require__.e("default~pages-profile-profile-module~profile-profile-module"), __webpack_require__.e("common")]).then(__webpack_require__.bind(null, /*! ./pages/profile/profile.module */ "./src/app/pages/profile/profile.module.ts")).then(m => m.ProfilePageModule)
    },
    {
        path: 'edit-profile',
        loadChildren: () => Promise.all(/*! import() | pages-edit-profile-edit-profile-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-edit-profile-edit-profile-module")]).then(__webpack_require__.bind(null, /*! ./pages/edit-profile/edit-profile.module */ "./src/app/pages/edit-profile/edit-profile.module.ts")).then(m => m.EditProfilePageModule)
    },
    {
        path: 'notifications',
        loadChildren: () => Promise.all(/*! import() | pages-notifications-notifications-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-notifications-notifications-module")]).then(__webpack_require__.bind(null, /*! ./pages/notifications/notifications.module */ "./src/app/pages/notifications/notifications.module.ts")).then(m => m.NotificationsPageModule)
    },
    {
        path: 'tracker',
        loadChildren: () => Promise.all(/*! import() | pages-tracker-tracker-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-tracker-tracker-module")]).then(__webpack_require__.bind(null, /*! ./pages/tracker/tracker.module */ "./src/app/pages/tracker/tracker.module.ts")).then(m => m.TrackerPageModule)
    },
    {
        path: 'inbox',
        loadChildren: () => Promise.all(/*! import() | pages-inbox-inbox-module */[__webpack_require__.e("default~contacts-contacts-module~pages-inbox-inbox-module~pages-order-detail-order-detail-module~rev~7ba3eaa7"), __webpack_require__.e("pages-inbox-inbox-module")]).then(__webpack_require__.bind(null, /*! ./pages/inbox/inbox.module */ "./src/app/pages/inbox/inbox.module.ts")).then(m => m.InboxPageModule)
    },
    {
        path: 'languages',
    ...
    {
        path: 'contacts',
        loadChildren: () => Promise.all(/*! import() | pages-contacts-contacts-module */[__webpack_require__.e("default~contacts-contacts-module~pages-inbox-inbox-module~pages-order-detail-order-detail-module~rev~7ba3eaa7"), __webpack_require__.e("contacts-contacts-module")]).then(__webpack_require__.bind(null, /*! ./pages/contacts/contacts.module */ "./src/app/pages/contacts/contacts.module.ts")).then(m => m.ContactsPageModule)
    },
    {
        path: 'faqs',
    ...
    {
        path: 'reviews',
        loadChildren: () => Promise.all(/*! import() | pages-reviews-reviews-module */[__webpack_require__.e("default~contacts-contacts-module~pages-inbox-inbox-module~pages-order-detail-order-detail-module~rev~7ba3eaa7"), __webpack_require__.e("reviews-reviews-module")]).then(__webpack_require__.bind(null, /*! ./pages/reviews/reviews.module */ "./src/app/pages/reviews/reviews.module.ts")).then(m => m.ReviewsPageModule)
    },
];
        ...
        this.platform.ready().then(() => {
            ...
            if (this.platform.is('cordova')) {
                ...
                setTimeout(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    yield this.oneSignal.startInit(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].onesignal.appId, src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].onesignal.googleProjectNumber);
...
/* harmony import */ var _pages_select_country_select_country_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./pages/select-country/select-country.module */ "./src/app/pages/select-country/select-country.module.ts");
/* harmony import */ var _pages_verify_verify_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./pages/verify/verify.module */ "./src/app/pages/verify/verify.module.ts");
...
module.exports = __webpack_require__(/*! /Users/alejandrodiaz/Desktop/MrManda2 Repartidor/src/main.ts */"./src/main.ts");
