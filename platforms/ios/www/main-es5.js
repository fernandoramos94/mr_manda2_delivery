(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /Users/fernandoramostimote/Documents/MrManda2 Repartidor/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      */
        ...
        _createClass(AppComponent, [{
          ...
          value: function getLocation() {
            ...
            this.geolocation.getCurrentPosition().then(function (resp) {
              ...
              _this6.updateLocation(resp.coords.latitude, resp.coords.longitude);
            ...
            watch.subscribe(function (data) {
              ...
              _this6.updateLocation(data.coords.latitude, data.coords.longitude);
            });
          }
        }, {
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this7.nativeAudio.stop('audio').then(function () {
          ...
          value: function initializeApp() {
            ...
            this.platform.ready().then(function () {
              _this8.statusBar.backgroundColorByHexString('#00b3f0');

              _this8.splashScreen.hide();

              if (_this8.platform.is('cordova')) {
                setTimeout(function () {
                  return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this8, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
                    var _this9 = this;
                    ...
                    return regeneratorRuntime.wrap(function _callee11$(_context11) {
                      while (1) {
                        switch (_context11.prev = _context11.next) {
                          case 0:
                            _context11.next = 2;
                            return this.oneSignal.startInit(src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].onesignal.appId, src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].onesignal.googleProjectNumber);
                          ...
                          case 2:
                            this.oneSignal.getIds().then(function (data) {
                              ...
                              if (uid && uid !== null && uid !== 'null') {
                                ...
                                _this9.api.post('drivers/edit_profile', param).then(function (data) {}, function (error) {
                                  console.log(error);
                                });
                              }
                            });
                ...
                _this8.nativeAudio.preloadSimple('audio', 'assets/alert.mp3').then(function (data) {}, function (error) {})["catch"](function (error) {});

                _this8.oneSignal.handleNotificationReceived().subscribe(function (data) {
                  _this8.nativeAudio.play('audio', function () {
                    return console.log('audio is done playing');
                  })["catch"](function (error) {
                    return console.log(error);
                  });

                  _this8.nativeAudio.setVolumeForComplexAsset('audio', 1);

                  _this8.presentActionSheet();
                });

                _this8.oneSignal.inFocusDisplaying(2);
              }

              _this8.appPages = _this8.util.appPages;
              var lng = localStorage.getItem('language');

              if (!lng || lng === null) {
                _this8.api.get('users/getDefaultSettings').then(function (data) {
                  if (data && data.status === 200 && data.data) {
                    ...
                    if (manage && manage.length > 0) {
                      if (manage[0].app_close === 0 || manage[0].app_close === '0') {
                        _this8.util.appClosed = true;
                        _this8.util.appClosedMessage = manage[0].message;
                      } else {
                        _this8.util.appClosed = false;
                      }
                    } else {
                      _this8.util.appClosed = false;
                    }
                    ...
                    if (language) {
                      _this8.util.translations = language;
                    ...
                    if (settings && settings.length > 0) {
                      var info = settings[0];
                      _this8.util.direction = info.appDirection;
                      _this8.util.cside = info.currencySide;
                      _this8.util.currecny = info.currencySymbol;
                      _this8.util.logo = info.logo;
                      _this8.util.twillo = info.twillo;
                      _this8.util.delivery = info.delivery;
                      _this8.util.user_login = info.driver_login;
                      _this8.util.reset_pwd = info.reset_pwd;
                      document.documentElement.dir = _this8.util.direction;
                    } else {
                      _this8.util.direction = 'ltr';
                      _this8.util.cside = 'right';
                      _this8.util.currecny = '$';
                      document.documentElement.dir = _this8.util.direction;
                    }
                ...
                _this8.api.post('users/getDefaultSettingsById', param).then(function (data) {
                  if (data && data.status === 200 && data.data) {
                    var manage = data.data.manage;
                    var language = data.data.lang;
              ...
              if (uid && uid !== null && uid !== 'null') {
                ...
                _this8.api.post('drivers/getById', _param).then(function (data) {
                  if (data && data.status === 200 && data.data && data.data.length) {
                    _this8.util.userInfo = data.data[0];
                  }
                }, function (error) {});
              }
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_7__["Geolocation"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_8__["ApiService"], _ionic_native_onesignal_ngx__WEBPACK_IMPORTED_MODULE_9__["OneSignal"], _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_11__["NativeAudio"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ActionSheetController"], _services_util_service__WEBPACK_IMPORTED_MODULE_12__["UtilService"], _angular_router__WEBPACK_IMPORTED_MODULE_13__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"]])], AppComponent);
      /***/
    },
        ...
        _createClass(VerifyPage, [{
          ...
          value: function sendOTP() {
            ...
            this.api.post('users/twilloMessage', param).then(function (data) {
              ...
              _this11.util.errorToast('Algo ha ido mal');
            });
          }
        }, {
          key: "ngOnInit",
            ...
            if (this.userCode) {
              ...
              this.api.post('users/verifyOTP', param).then(function (data) {
                ...
                if (data && data.status === 200) {
                  ...
                  _this12.util.errorToast('Algo ha ido mal');
      ...
      */
      ...
      var SelectCountryPage = /*#__PURE__*/function () {
        function SelectCountryPage(modalCtrl, util) {
          ...
          setTimeout(function () {
            _this13.dummyLoad = [];
            _this13.dummy = _this13.util.countrys;
            _this13.countries = _this13.dummy;
            console.log(_this13.dummy);
          }, 500);
        }
