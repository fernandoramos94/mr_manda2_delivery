...
let OrderDetailPage = class OrderDetailPage {
    constructor(route, api, router, util, navCtrl, iab, modalCtrl) {
        this.route = route;
        this.api = api;
        this.router = router;
        this.util = util;
